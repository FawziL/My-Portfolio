...
function Contact() {
    ...
    return (
        <div id="Contact">
            ...
            <div>
                <p className="text">
                    <FormattedMessage id="contactPresentation" />
                </p>
                <div className="socialdFlex">
                    ...
                    <div>
                        <div className="SocialComponent">
                            ...
                            <a href="https://github.com/FawziL" target="_blank">
                                github.com/FawziL
                            </a>
                        </div>
                        <div className="SocialComponent">
                            ...
                            <a
                                href="https://linkedin.com/in/fawzi-lutfallah-62184b236/"
                                target="_blank"
                            >
                                fawzi-lutfallah
                            </a>
