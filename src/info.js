...
const proyects = [
    {
        ...
        code: "https://github.com/FawziL/Reservation-System",
        live: "https://reservation-system-rose-pi.vercel.app",
        tecnologies: [nestjs, nextjs, postgresql, tailwind],
    },
    {
        id: "6",
        title: "Biblioteca",
        ...
        texto: "Aplicación fullstack que permite a los usuarios buscar, visualizar y gestionar libros en línea, con autenticación mediante JWT y un frontend en React. Incluye funcionalidades como favoritos, filtrado por categorías, y recuperación de contraseñas.",
...
const tecnologies = [
    ...
    },
    {
        id: 13,
        name: "NestJS",
        text: "NestJS is a progressive Node.js framework for building efficient, reliable, and scalable server-side applications.",
        texto: "NestJS es un framework progresivo de Node.js para construir aplicaciones del lado del servidor eficientes, confiables y escalables.",
        tecnology: nestjs,
    },
    {
        id: 14,
